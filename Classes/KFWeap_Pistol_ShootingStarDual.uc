class KFWeap_Pistol_ShootingStarDual extends KFWeap_DualBase;

const MAX_LOCKED_TARGETS = 12;
...
{
	local Pawn RecentlyLocked, StaticLockedTargets[12];
...
defaultproperties
{
    ...
    SingleClass=class'KFWeap_Pistol_ShootingStar'
    ...
    WeaponProjectiles(ALTFIRE_FIREMODE)=class'KFProj_Bullet_Pistol_ShootingStar'
    FireInterval(ALTFIRE_FIREMODE)=+0.1
    InstantHitDamage(ALTFIRE_FIREMODE)=75.0 //70.0
    InstantHitDamageTypes(ALTFIRE_FIREMODE)=class'KFDT_Ballistic_ShootingStar'
