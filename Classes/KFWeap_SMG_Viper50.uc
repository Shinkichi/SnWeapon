...
class KFWeap_SMG_Viper50 extends KFWeap_SMGBase;
...
defaultproperties
{
	...
	SpareAmmoCapacity[0]=90//320 //360
	...
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'KFDT_Ballistic_Viper50'
	...
	InstantHitDamageTypes(ALTFIRE_FIREMODE)=class'KFDT_Ballistic_Viper50'
	PenetrationPower(ALTFIRE_FIREMODE)=2.0
	FireInterval(ALTFIRE_FIREMODE)=+0.2//+0.12
	InstantHitDamage(ALTFIRE_FIREMODE)=91
	Spread(ALTFIRE_FIREMODE)=0.01
	//BurstAmount=3

	// BASH_FIREMODE
	InstantHitDamageTypes(BASH_FIREMODE)=class'KFDT_Bludgeon_Viper50'
