class KFProj_Bullet_Pistol_ShootingStarDual extends KFProj_Bullet
    hidedropdown;
...
simulated event Tick( float DeltaTime )
{
		...
		&& `TimeSince(CreationTime) > 0.03f )
	{
		...
		TargetImpactPos = class'KFWeap_Pistol_ShootingStarDual'.static.GetLockedTargetLoc( LockedTarget );
