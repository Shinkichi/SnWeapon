class KFExplosion_Healingbuss extends KFExplosionActorLingering;
...
protected simulated function AffectsPawn(Pawn Victim, float DamageScale)
{
	...
	else
	{
		...
		KFP.ApplyDamageOverTime(class'KFDT_Toxic_Healingbuss'.default.PoisonPower, Instigator.Controller, class'KFDT_Toxic_HRG_MedicMissile');
	}
}
