...
class KFWeap_Shotgun_M1897Trenchgun extends KFWeap_ShotgunBase;
...
defaultproperties
{
	...
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'KFDT_Ballistic_M1897Trenchgun'
	...
	// BASH_FIREMODE
	InstantHitDamageTypes(BASH_FIREMODE)=class'KFDT_Bludgeon_M1897Trenchgun'
